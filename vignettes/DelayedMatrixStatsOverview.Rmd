...
microbenchmark(
  ...
  times = 10)
profmem::total(profmem::profmem(DelayedArray::colSums(dm_matrix)))
profmem::total(profmem::profmem(DelayedMatrixStats::colSums2(dm_matrix)))
...
microbenchmark(
  ...
  times = 10)
profmem::total(profmem::profmem(DelayedArray::colSums(dm_dgCMatrix)))
profmem::total(profmem::profmem(DelayedMatrixStats::colSums2(dm_dgCMatrix)))
