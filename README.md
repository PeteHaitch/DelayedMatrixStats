...
#> Unit: milliseconds
#>                                        expr       min        lq      mean
#>         DelayedArray::colSums(dense_matrix) 472.47066 792.96441 912.77549
#>  DelayedMatrixStats::colSums2(dense_matrix)  15.67388  16.47122  17.71857
#>     median        uq        max neval
#>  883.23964 966.72484 1597.43389    10
#>   17.58971  18.05285   22.29105    10
...
#> Unit: milliseconds
#>                                         expr       min        lq      mean
#>         DelayedArray::colSums(sparse_matrix) 544.74512 572.40745 641.16974
#>  DelayedMatrixStats::colSums2(sparse_matrix)  20.36499  22.51755  23.91562
#>     median        uq      max neval
#>  579.13279 604.56606 913.3229    10
#>   23.42342  25.69337  27.7077    10
...
#> Unit: milliseconds
#>                                      expr         min          lq        mean
#>         DelayedArray::colSums(rle_matrix) 1161.254067 1181.143832 1328.463271
#>  DelayedMatrixStats::colSums2(rle_matrix)    3.249279    3.679856    9.808217
#>       median         uq        max neval
#>  1242.375683 1383.61702 1828.68841    10
#>     4.304635   10.22109   40.66806    10
