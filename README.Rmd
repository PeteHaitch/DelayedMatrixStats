...
**NOTE:** `colWeightedSds()`, `colWeightedVars()`, `rowWeightedSds()`, and 
...
api_tbl <- tibble::tibble(
  ...
  `_base::matrix_ optimized` = 
    ifelse(sapply(matrixStats, hasMethod, signature = "matrix"), 
           emo::ji("heavy_check_mark"), 
           emo::ji("x")),
  ...
  `_DelayedArray::RleArray_ (_SolidRleArraySeed_) optimized` = 
    ifelse(sapply(matrixStats, hasMethod, signature = "SolidRleArraySeed"),
           emo::ji("heavy_check_mark"), 
           emo::ji("x")),
  `_DelayedArray::RleArray_  (_ChunkedRleArraySeed_) optimized` = 
    ifelse(sapply(matrixStats, hasMethod, signature = "ChunkedRleArraySeed"),
           emo::ji("heavy_check_mark"), 
           emo::ji("x")),
  `_HDF5Array::HDF5Matrix_ optimized` = 
    ifelse(sapply(matrixStats, hasMethod, signature = "HDF5ArraySeed"),
           emo::ji("heavy_check_mark"), 
           emo::ji("x")),
  `_base::data.frame_ optimized` = 
    ifelse(sapply(matrixStats, hasMethod, signature = "data.frame"),
           emo::ji("heavy_check_mark"), 
           emo::ji("x")),
  `_S4Vectors::DataFrame_ optimized` =
    ifelse(sapply(matrixStats, hasMethod, signature = "DataFrame"),
           emo::ji("heavy_check_mark"), 
           emo::ji("x")))
knitr::kable(api_tbl)
```
