...
[![Coverage Status](https://img.shields.io/codecov/c/github/PeteHaitch/DelayedMatrixStats/master.svg)](https://codecov.io/github/PeteHaitch/DelayedMatrixStats?branch=master)
...
# TODO: Make a data frame mapping block-processing strategy methods to 
#       matrixStats methods
# TODO: Make a data frame of which methods have optimized seed-aware 
#       implementations and print as table in README
# api_df <- data.frame(
#   Method = matrixStats,
#   # `Block processing` = ifelse(matrixStats %in% DelayedMatrixStats,
#   #                             emo::ji("ok"),
#   #                             emo::ji("x")),
#   `base::matrix optimized` = ,
#   `Matrix::Matrix optimized` = ,
#   `DelayedArray::RleArray optimized` = ,
#   `HDF5Array::HDF5Matrix optimized` = ,
#   `base::data.frame optimized` = ,
#   `S4Vectors::DataFrame optimized` =
