...
- **NOTE:** `colAvgsPerRowSet()` will be implemented/reinstated upon the next CRAN release of **matrixStats** ([https://github.com/PeteHaitch/DelayedMatrixStats/issues/34](https://github.com/PeteHaitch/DelayedMatrixStats/issues/34))
